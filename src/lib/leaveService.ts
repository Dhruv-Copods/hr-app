...
export async function createLeaveRecord(leaveData: CreateLeaveRecordData): Promise<LeaveRecord> {
  try {
...
export async function updateLeaveRecord(id: string, leaveData: UpdateLeaveRecordData): Promise<LeaveRecord> {
  try {
